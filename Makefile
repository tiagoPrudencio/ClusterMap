...
SOURCES = \
	__init__.py \
	Clustering.py Clustering_dialog.py

PLUGINNAME = Clustering

PY_FILES = \
	__init__.py \
	Clustering.py Clustering_dialog.py

UI_FILES = Clustering_dialog_base.ui
...
QGISDIR=C:\Users\Sony\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
